...
import MainImg from '../../../../src/images/prompt_eval/prompt_main.png';
...
const PromptEval = () => {
  ...
  const one = <div className="Title_MoxieChallenges">
                ...
                <div className='Title_MoxieChallenges_h2'>Prompt Evaluator</div>
              </div>;
  const two = <img className="mainimg" src={MainImg} alt="Main img"></img>;
  const three = <div className="text_holder">
                  <div className="left_text">
                  Prompt Evaluator is an AI assistant tool specifically designed for product managers and developers. With a strong emphasis on versatility, this tool empowers users to effectively solve a wide range of problems tailored to their unique use cases. By enabling prompt template engineering and enhancement, it ensures that prompts are both easily testable and maintainable.
                  </div>
                  <div className="role">
                    <div className='header'>MY ROLE</div>
                    <div className="content">UX Design and ideation, interaction design and prototype</div>
                  ...
                  <div className='team'>
                    <div className='header'>TEAM</div>
                      <div className="content">
                      Rachin Kapoor, VP Of Engineering <br />
                        Dnyaneshwari Abuj, Software Engineer<br />
                        Yash Shah, Senior Software Engineer<br />
                        Yagnik Thummar, SDE Intern<br />
                        Khushi Jain, SDE Intern<br />
                      </div>
                      <div className='header header-margin-2'>TAGS</div>
                      <div className="content">#UXDesign  #B2B #AI_Assistant #OpenSource</div>
                  </div>
