...
const Whats_Next_Featured = () => {
  const data = useStaticQuery(graphql`
    query {
      featured: allMarkdownRemark(
        filter: { fileAbsolutePath: { regex: "/moxie_challenges_next/" } }
              ...
              <StyledProject key={i} ref={el => (revealProjects.current[i] = el)}>
                <div className="project-content">
                  ...
                  <div className="project-links">
                    ...
                    {external && (
                      <a href={internal} aria-label="External Link" target="_blank">
                        <Icon name="External" />
                      </a>
                    )}
                  </div>
...
export default Whats_Next_Featured;
