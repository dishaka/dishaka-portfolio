...
const VerifiedBadgeNext = () => {
  ...
  const one = <a className='content' href='\featured_internal\onboarding'>
                <div className='next'>NEXT PROJECT >></div>
                <div className='next_project'>Onboarding</div>
                </a>
...
export default VerifiedBadgeNext;
