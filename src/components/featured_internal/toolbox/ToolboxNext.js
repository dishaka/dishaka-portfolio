...
const ToolBox_Whats_Next = () => {
  ...
  const one = <a className='content' href='\featured_internal\anchor'>
                <div className='next'>NEXT PROJECT >></div>
                <div className='next_project'>Anchor</div>
                </a>
...
export default ToolBox_Whats_Next;
